...
module.exports = function(app) {
  ...
  // ----------------------------------------------------------------------------
  app.get("/api/totals/:choice_type/:topic_id", function (req, res) {
  ...
  // ----------------------------------------------------------------------------
  app.get("/api/:choice_type/:user_id/:topic_id", function (req, res) {
  ...
  // ----------------------------------------------------------------------------
  app.put("/api/:choice_type", function(req, res) {
